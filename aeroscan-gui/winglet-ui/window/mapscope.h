#ifndef WINGLETUI_MAPSCOPE_H
#define WINGLETUI_MAPSCOPE_H
...
class MapScope : public QWidget
{
    Q_OBJECT
public:
    explicit MapScope(QWidget *parent = nullptr);
    ~MapScope();
    ...
    int age_limit = 100;
    float pixel_to_miles = 6.05727592658006f; // mapValue[9]
    int line_x = 240;
    int line_y = -920;
    double angle = 0;
